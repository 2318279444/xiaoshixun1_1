...
import com.bw.zhoumozuoye2020_02_22.R;
...
 *@Description:
 **/
public class MyZhengzaiAdapter extends RecyclerView.Adapter<MyZhengzaiAdapter.Holder> {
...
//    .CastsBean.AvatarsBean
    public MyZhengzaiAdapter(List<ZhengzaiBean.SubjectsBean> list, Context context) {
        this.list = list;
    ...
    public Holder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.zheng1, null);
