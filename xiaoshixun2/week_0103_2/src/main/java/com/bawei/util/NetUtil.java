...
public class NetUtil {
    ...
    public void netFenlei(String url, Class cls, final Icontract.ToCall toCall){
   ...
   public void netxiangqing(String url, Class cls, Map<String,Object> map, final Icontract.ToCall toCall){
