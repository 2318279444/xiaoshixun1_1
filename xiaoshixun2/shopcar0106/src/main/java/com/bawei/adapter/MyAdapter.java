...
import com.bawei.shopcar0106.R;
...
public class MyAdapter extends RecyclerView.Adapter<MyAdapter.Holder> {
    ...
    public void onBindViewHolder(@NonNull Holder holder, int position) {
        ...
        holder.bigrecyclerView.setAdapter(new smallAdapter(list.get(position).getShoppingCartList(),position));
    ...
    public class smallAdapter extends RecyclerView.Adapter<smallAdapter.smallHolder>{
        List<ShopBean.ResultBean.ShoppingCartListBean> llist;
        int ind;

        public smallAdapter(List<ShopBean.ResultBean.ShoppingCartListBean> llist, int ind) {
            this.llist = llist;
            this.ind = ind;
        }
