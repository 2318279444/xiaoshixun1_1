...
public class NetUtil {
    ...
    public boolean getConnettion(Context context){
    ...
    public void NetShouye(String url,Class cls,Map<String,Object> map,Icontract.ToCall toCall){
        myGet.toShousuo(url,map).observeOn(AndroidSchedulers.mainThread())
                .subscribeOn(Schedulers.io())
                .subscribe(new Consumer<ResponseBody>() {
                    @Override
                    public void accept(ResponseBody responseBody) throws Exception {
