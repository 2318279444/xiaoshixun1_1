...
public class GwcBean {
    ...
    public boolean isStus() {
        return stus;
    }

    public void setStus(boolean stus) {
        this.stus = stus;
    }
