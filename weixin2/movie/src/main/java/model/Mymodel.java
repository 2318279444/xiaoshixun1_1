...
public class Mymodel {
    ...
    public void m_Juzhao(String url,Class cls,Map<String,Object> map,Map<String,Object> map1,Icontract.ToCall toCall){
        NetUtil.getInstance().Net_Juzhao(url, cls, map,map1, new Icontract.ToCall() {
            @Override
            public void success(String stra) {
                toCall.success(stra);
            }
    ...
    public void m_Guanzhu(String url,Class cls,Map<String,Object> map,Map<String,Object> map1,Icontract.ToCall toCall){
        NetUtil.getInstance().Net_guanzhu(url, cls, map,map1, new Icontract.ToCall() {
            @Override
            public void success(String stra) {
                toCall.success(stra);
            }
