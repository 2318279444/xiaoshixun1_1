...
public class LoginActivity extends BaseActivity {
    ...
    protected void iniview() {
        wx=findViewById(R.id.Shouye_weixin);
            ...
            public void onClick(View view) {
                ...
                NetUtil.getInstance().NetDenglu(MyUrl.BASEDengLu, DengLuBean.class, map, new Icontract.ToCall() {
                    ...
                    public void success(String stra) {
                        ...
                        sessionId = dengLuBean.getResult().getSessionId();
                        //个人信息
                        userI = dengLuBean.getResult().getUserId();
                        String userId = String.valueOf(userI);
