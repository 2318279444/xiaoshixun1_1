...
 *@Description:
 **/
public class MyShouye_jijiang2_Adapter extends RecyclerView.Adapter<MyShouye_jijiang2_Adapter.Holder> {
    List<JijiangBean.ResultBean> list;
    Context context;



    public MyShouye_jijiang2_Adapter(List<JijiangBean.ResultBean> list, Context context) {
        this.list = list;
...
//        holder.jijiangyuyue.setOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View v) {
//                toJijiangCall.imaonclick(position);
//            }
//        });
    ...
    class Holder extends RecyclerView.ViewHolder{
        ImageView imageView,jijiangyuyue;
...
//            jijiangyuyue=itemView.findViewById(R.id.jijiang_yuyue);
