...
 *@Description:
 **/
public class My_YueyueAdapter extends RecyclerView.Adapter<My_YueyueAdapter.Holder> {
    List<My_YueyueBean.ResultBean> list;
    Context context;



    public My_YueyueAdapter(List<My_YueyueBean.ResultBean> list, Context context) {
        this.list = list;
