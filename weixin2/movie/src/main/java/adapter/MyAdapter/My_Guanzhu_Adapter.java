...
 *@Description:
 **/
public class My_Guanzhu_Adapter extends RecyclerView.Adapter<My_Guanzhu_Adapter.Holder> {
    List<My_GuanzhuBean.ResultBean> list;
    Context context;



    public My_Guanzhu_Adapter(List<My_GuanzhuBean.ResultBean> list, Context context) {
        this.list = list;
