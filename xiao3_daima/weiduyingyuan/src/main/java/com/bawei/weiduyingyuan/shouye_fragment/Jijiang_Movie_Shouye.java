...
//        }
        ...
        MyShouye_jijiang_Adapter myShouye_jijiang_adapter = new MyShouye_jijiang_Adapter(jijiangBean.getResult(), getActivity());
        recyclerView.setAdapter(myShouye_jijiang_adapter);

        myShouye_jijiang_adapter.setToJijiangCall(new MyShouye_jijiang_Adapter.ToJijiangCall() {
            @Override
