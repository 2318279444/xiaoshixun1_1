...
import com.bawei.weiduyingyuan.Select_Seat;
...
public class Paiqi_three extends BaseFragment {
    ...
    protected void iniview(View view) {
        recyclerView=getActivity().findViewById(R.id.Recyc_Ying_Paiqi3);
    ...
    protected int inilayout() {
        return R.layout.activity_paiqi_three;
    }
