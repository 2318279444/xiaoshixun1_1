...
 *@Description:
 **/
public class MyDDAdapter4 extends RecyclerView.Adapter<MyDDAdapter4.Holder> {
    List<DdBean.OrderListBean> list;
    Context context;


    public MyDDAdapter4(List<DdBean.OrderListBean> list, Context context) {
        this.list = list;
