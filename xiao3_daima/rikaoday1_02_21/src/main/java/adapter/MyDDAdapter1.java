...
 *@Description:
 **/
public class MyDDAdapter1 extends RecyclerView.Adapter<MyDDAdapter1.Holder> {
    List<DdBean.OrderListBean> list;
    Context context;


    public MyDDAdapter1(List<DdBean.OrderListBean> list, Context context) {
        this.list = list;
    ...
    public class Small extends RecyclerView.Adapter<Small.Holder>{
        ...
        @Override
        public Holder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(context).inflate(R.layout.small1, null);
            return new Holder(view);
        }
