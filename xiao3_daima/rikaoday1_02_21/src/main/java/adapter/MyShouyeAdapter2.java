...
 *@Description:
 **/
public class MyShouyeAdapter2 extends RecyclerView.Adapter<MyShouyeAdapter2.Holder> {
    List<ShouyeBean.ResultBean.MlssBean.CommodityListBeanXX> list;
    Context context;

    public MyShouyeAdapter2(List<ShouyeBean.ResultBean.MlssBean.CommodityListBeanXX> list, Context context) {
        this.list = list;
    ...
    public Holder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_ml, null);
