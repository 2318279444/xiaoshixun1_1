package com.bawei.rikaoday1_02_21.fragment.ddfragment;
...
public class DaiFinish extends BaseFragment {
    ...
    protected void inidata(Bundle savedInstanceState) {
        ...
        NetUtil.getInstance().NetDD(MyUrl.BASEDD, DdBean.class, map, map1, new Icontract.ToCall() {
            ...
            public void success(String stra) {
                ...
                MyDDAdapter1 myDDAdapter1 = new MyDDAdapter1(ddBean.getOrderList(), getActivity());
    ...
    protected int inilayout() {
        return R.layout.activity_dai_finish;
    }
