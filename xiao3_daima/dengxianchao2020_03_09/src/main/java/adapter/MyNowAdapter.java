...
import com.bawei.dengxianchao2020_03_09.R;
...
 *@Description:
 **/
public class MyNowAdapter extends RecyclerView.Adapter<MyNowAdapter.Holder> {
    List<NowMovieBean.ResultBean> list;
    Context context;

    public MyNowAdapter(List<NowMovieBean.ResultBean> list, Context context) {
        this.list = list;
